...
impl Script {
    pub fn new(
        ...
        Ok(Arc::downcast::<Script>(registered).unwrap_or(candidate))
    }
    ...
    pub fn render(self: Arc<Self>, path_to_root: &str) -> Markup {
        ...
        html! {
            ...
            script type="module" src=(canonicalize_web_path(&self.web_path(path_to_root))){}
        }
    }
}
