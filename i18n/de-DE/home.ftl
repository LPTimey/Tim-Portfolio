...
hi = Hi!
description = Willkommen auf meinem Portfolio! Hier finden Sie Informationen über mich, meine technischen Fähigkeiten und meine Projekte.
Design = Design
ICT = EDV
languages = Sprachen
...
Experience = Meine Erfahrung
today = Heute
UXD = UX Design Studium (B.Sc.)
FOS-tech = Technik-Zweig
Georg-Hipp = Georg-Hipp Realschule
math-track = Mathematik-Zweig